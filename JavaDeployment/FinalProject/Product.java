...
public class Product {
    ...
    public boolean sell(int amount) {
        ...
        // If successful, reduce quantity and return true
    ...
    public String toString() {
        ...
        // Suggested format: "Product{id='B001', name='Java Book', type='BOOK',
        // price=29.99, quantity=5}"
        return "Product{id='" + id + "', name='" + name + "', type='" + type + "', price=" + price + ", quantity="
