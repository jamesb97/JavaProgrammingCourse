...
public class ProductService {
    ...
    public ProductDTO getByProductName(String productName) {
        ...
        if (productsDTO != null && productsDTO.getProducts() != null && !productsDTO.getProducts().isEmpty()) {
            ...
            productsDTO = getData();
            productDTO = productsDTO.getProducts().stream().filter(product -> product.getProduct().equals(productName))
                    .findFirst().orElseThrow(() -> new RuntimeException("Product not found"));
        }
    ...
    private ProductsDTO getData() {
        ...
        // Arrays.asList(
        // new ProductDTO("Headphones", Arrays.asList("Binglee", "DXC Electronics",
        // "Bobay")),
        // new ProductDTO("Laptop", Arrays.asList("GH Computers", "Tech city", "Ez
        // PC")),
        // new ProductDTO("Mouse", Arrays.asList("DXC Electronics", "Tech City")),
        // new ProductDTO("Printer", Arrays.asList("Binglee", "DXC Electronics",
        // "Bobay", "GH Computers"))
        // ));
