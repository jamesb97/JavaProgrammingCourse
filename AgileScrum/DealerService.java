...
public class DealerService {
    ...
    private DealersDTO getData() {
        ...
        // new DealerDTO("DXC Electronics", Map.of("Mouse", "$20", "Printer", "$85",
        // "Headphones", "$20")),
    ...
    public List<AbstractMap.SimpleEntry<String, String>> getAllProductPrices(String productName) {
        ...
        return dealersDTO.getDealers().stream()
                ...
                .map(dealerDTO -> new AbstractMap.SimpleEntry<>(dealerDTO.getDealer(),
                        dealerDTO.getProducts().get(productName)))
                .toList();
    }
}
